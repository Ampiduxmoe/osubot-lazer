...
import {SerializedObjectsTable} from '../../../../../main/data/persistence/db/tables/SerializedObjectsTable';
import {
  SerializedObject,
  SerializedObjectKey,
} from '../../../../../main/data/repository/models/SerializedObject';
import {describeBaseTableMethods} from './GenericTableTest';
import {SerializationDescriptor} from '../../../../../main/primitives/SerializationDescriptor';
